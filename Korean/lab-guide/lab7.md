...
[작업 1: 보고서 자동 생성
[3](#작업-1-보고서-자동-생성)](#작업-1-보고서-자동-생성)

[작업 2: 새 보고서의 배경 구성
[7](#작업-2-새-보고서의-배경-구성)](#작업-2-새-보고서의-배경-구성)

[작업 3: 보고서에 헤더 추가
[10](#작업-3-보고서에-헤더-추가)](#작업-3-보고서에-헤더-추가)

[작업 4: 보고서에 KPI 추가
[10](#작업-4-보고서에-kpi-추가)](#작업-4-보고서에-kpi-추가)

[작업 5: 보고서에 꺾은선형 차트 추가
[13](#작업-5-보고서에-꺾은선형-차트-추가)](#작업-5-보고서에-꺾은선형-차트-추가)

[작업 6: 보고서 저장 [14](#작업-6-보고서-저장)](#작업-6-보고서-저장)

[작업 7: Date 테이블의 Year 열 구성
[14](#작업-7-date-테이블의-year-열-구성)](#작업-7-date-테이블의-year-열-구성)

[작업 8: Date 테이블의 Month Name 열 구성
[15](#작업-8-date-테이블의-month-name-열-구성)](#작업-8-date-테이블의-month-name-열-구성)

[작업 9: 꺾은선형 차트 형식 지정
[17](#작업-9-꺾은선형-차트-형식-지정)](#작업-9-꺾은선형-차트-형식-지정)

[작업 10: 의미 체계 모델에 Power BI Desktop 연결
[19](#작업-10-의미-체계-모델에-power-bi-desktop-연결)](#작업-10-의미-체계-모델에-power-bi-desktop-연결)

[작업 11: Direct Lake 모드를 시뮬레이션하기 위해 새 데이터 추가
[22](#작업-11-direct-lake-모드를-시뮬레이션하기-위해-새-데이터-추가)](#작업-11-direct-lake-모드를-시뮬레이션하기-위해-새-데이터-추가)

[랩 환경 정리 [31](#랩-환경-정리)](#랩-환경-정리)
...
1.  다시 랩 2에서 만든 **Fabric 작업 영역, FAIAD\_\<username\>**으로
    되돌아가 보겠습니다.

2.  왼쪽 패널의 아래쪽에서 **Fabric 환경 선택기** 아이콘을 선택합니다.

![](lab-07/media/image6.png){width="3.67in"
height="2.3268996062992127in"}

3.  Fabric 환경 대화 상자가 열립니다. **Power BI**를 선택합니다. **Power
    BI 홈 페이지**로 이동합니다.

![](lab-07/media/image7.png){width="3.0385695538057744in"
height="1.9014938757655293in"}

4.  상단 메뉴에서 **새 보고서**를 선택합니다.

![](lab-07/media/image8.png){width="3.021818678915136in"
height="1.5394160104986876in"}
...
![](lab-07/media/image9.png){width="6.074434601924759in"
height="2.5061286089238846in"}
...
![](lab-07/media/image10.png){width="5.389470691163605in"
height="3.6658497375328083in"}

8.  Power BI가 보고서 자동 만들기를 시작합니다. 보고서가 준비되면 화면
    오른쪽 상단에 대화 상자가 나타납니다. **지금 보고서를 보거나 몇 초
    후에 자동으로 로드**를 선택합니다.

![](lab-07/media/image11.png){width="5.733420822397201in"
height="1.812681539807524in"}
...
![](lab-07/media/image12.png){width="5.129220253718286in"
height="2.898416447944007in"}
...
![](lab-07/media/image13.png){width="5.7634208223972in"
height="3.059238845144357in"}
...
![](lab-07/media/image14.png){width="4.0737357830271215in"
height="1.743642825896763in"}

3.  **게시된 의미 체계 모델 선택**을 선택하면 우리가 만든 모델을 선택할
    수 있습니다.

![](lab-07/media/image15.png){width="3.920761154855643in"
height="2.1403346456692915in"}
...
![](lab-07/media/image16.png){width="4.697818241469816in"
height="3.1813167104111986in"}
...
![](lab-07/media/image17.png){width="5.467935258092738in"
height="3.374375546806649in"}
...
![](lab-07/media/image18.png){width="5.653578302712161in"
height="2.791119860017498in"}
...
![](lab-07/media/image19.png){width="2.7129068241469816in"
height="1.353597987751531in"}
...
![](lab-07/media/image20.png){width="3.8372583114610674in"
height="2.4488079615048117in"}
...
![](lab-07/media/image21.png){width="4.0851727909011375in"
height="4.1659076990376205in"}

11. **카드** 섹션을 확장합니다.

12. **악센트 바** 슬라이더를 **끄기**로 설정합니다.

![](lab-07/media/image22.png){width="3.4667246281714785in"
height="4.113845144356955in"}
...
![](lab-07/media/image23.png){width="5.783835301837271in"
height="1.7007185039370079in"}
...
![](lab-07/media/image24.png){width="2.986965223097113in"
height="2.4626946631671043in"}
...
![](lab-07/media/image25.png){width="5.231959755030621in"
height="3.1603871391076117in"}
...
![](lab-07/media/image26.png){width="1.1529418197725285in"
height="1.6402679352580927in"}
...
![](lab-07/media/image27.png){width="5.733314741907262in"
...
![](lab-07/media/image28.png){width="1.5046423884514435in"
height="2.4280216535433072in"}
...
![](lab-07/media/image29.png){width="4.230384951881015in"
height="2.154905949256343in"}
...
![](lab-07/media/image30.png){width="5.99580271216098in"
height="2.1247265966754156in"}

**참고:** 월이 알파벳순으로 정렬되어 있습니다. 이를 수정해 보겠습니다.

![](lab-07/media/image31.png){width="6.229751749781277in"
height="1.20794728783902in"}
...
![](lab-07/media/image32.png){width="1.639093394575678in"
height="2.294732064741907in"}

11. 브라우저의 **보고서 창/탭**으로 다시 이동합니다. 이제 월이 올바르게
    정렬되어 있습니다.

![](lab-07/media/image33.png){width="5.787684820647419in"
height="1.1151137357830272in"}
...
![](lab-07/media/image34.png){width="6.0431517935258094in"
height="2.817729658792651in"}
...
![](lab-07/media/image35.png){width="5.815130139982502in"
height="2.153752187226597in"}
...
![](lab-07/media/image36.png){width="6.111396544181977in"
height="3.950173884514436in"}
...
![](lab-07/media/image37.png){width="2.6816152668416446in"
...
![](lab-07/media/image38.png){width="2.9246784776902888in"
height="2.014779090113736in"}

5.  **왼쪽 패널**에서 **모델 보기** 아이콘을 선택합니다. 테이블 간의
    관계를 볼 수 있습니다.

![](lab-07/media/image39.png){width="4.126695100612423in"
height="3.0506583552055995in"}
...
![](lab-07/media/image40.png){width="3.755787401574803in"
height="1.9256003937007875in"}

10. **FAIADTemplate.pbix**로 이동하여 보고서 캔버스를 선택합니다.

11. 리본 메뉴에서 **홈 -\> 붙여넣기**를 선택합니다.

![](lab-07/media/image40.png){width="3.353066491688539in"
height="1.7191251093613298in"}

12. 마찬가지로 **Sales 및 Units KPI**를 복사하여 붙여넣습니다. 참고 -
    여러 시각적 개체를 복사하여 함께 붙여넣을 수 있습니다.

![](lab-07/media/image41.png){width="2.862582020997375in"
height="2.4915069991251095in"}
...
![](lab-07/media/image42.png){width="4.841711504811898in"
height="1.9602843394575677in"}
...
![](lab-07/media/image43.png){width="6.074864391951006in"
height="1.5304396325459317in"}
...
![](lab-07/media/image44.png){width="5.410869422572178in"
height="5.4330446194225726in"}

4.  **왼쪽 탐색기 창**에서 **테이블** 옆의 **줄임표**를 선택합니다.

5.  **새 바로 가기**를 선택합니다.

![](lab-07/media/image45.png){width="5.4792104111986in"
height="4.913175853018373in"}

6.  새 바로 가기 대화 상자가 열립니다. **외부 소스**에서 **Azure Data
    Lake Storage Gen2**를 선택합니다.

![](lab-07/media/image46.png){width="5.8in"
height="2.9969739720034996in"}
...
![](lab-07/media/image47.png){width="5.909694881889764in"
height="1.342017716535433in"}
...
![](lab-07/media/image48.png){width="3.7881999125109362in"
height="3.2134394138232723in"}
...
![](lab-07/media/image49.png){width="5.970885826771654in"
height="3.3102580927384078in"}
...
![](lab-07/media/image50.png){width="3.265172790901137in"
height="1.9411165791776028in"}
...
![](lab-07/media/image51.png){width="3.8457666229221346in"
height="3.361359361329834in"}
...
![](lab-07/media/image52.png){width="5.610313867016623in"
height="1.1510345581802275in"}
...
![](lab-07/media/image53.png){width="6.0in"
height="1.5869531933508312in"}
...
![](lab-07/media/image54.png){width="4.725878171478565in"
height="4.467351268591426in"}
...
![](lab-07/media/image55.png){width="1.870349956255468in"
