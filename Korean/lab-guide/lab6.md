...
[레이크하우스 -- 데이터 분석
[3](#레이크하우스-데이터-분석)](#레이크하우스-데이터-분석)

[작업 1: SQL을 사용한 데이터 쿼리
[3](#작업-1-sql을-사용한-데이터-쿼리)](#작업-1-sql을-사용한-데이터-쿼리)

[작업 2: T-SQL 결과 시각화
[5](#작업-2-t-sql-결과-시각화)](#작업-2-t-sql-결과-시각화)

[레이크하우스 - 의미 체계 모델링
[7](#레이크하우스---의미-체계-모델링)](#레이크하우스---의미-체계-모델링)

[작업 3: 의미 체계 모델 만들기
[7](#작업-3-의미-체계-모델-만들기)](#작업-3-의미-체계-모델-만들기)

[작업 4: 관계 만들기 [9](#작업-4-관계-만들기)](#작업-4-관계-만들기)

[작업 5: 측정값 만들기
[13](#작업-5-측정값-만들기)](#작업-5-측정값-만들기)

[작업 6: 선택 섹션 -- 관계 만들기
[16](#작업-6-선택-섹션-관계-만들기)](#작업-6-선택-섹션-관계-만들기)

[작업 7: 선택 섹션 -- 측정값 만들기
[20](#작업-7-선택-섹션-측정값-만들기)](#작업-7-선택-섹션-측정값-만들기)
...
1.  다시 랩 2, 작업 8에서 만든 Fabric 작업 영역
    **FAIAD\_\<username\>**(으)로 되돌아가 보겠습니다.

2.  원하는 경우 **작업 흐름을 최소화**하여 전체 항목 목록을 볼 수
    있습니다.

3.  레이크하우스, 의미 체계 모델, **SQL 엔드포인트 등** **lh_FAIAD**와
    관련된 세 가지 요소를 볼 수 있습니다. 이전 랩에서 레이크하우스를
    탐색하고 SQL 분석 엔드포인트를 사용하여 시각적 쿼리를 만들었습니다.
    이 옵션을 계속 탐색하려면 lh_FAIAD SQL 분석 엔드포인트 옵션을
    선택합니다. 탐색기의 **SQL 보기**로 이동합니다.

![](lab-06/media/image7.png){width="4.06875in"
...
![](lab-06/media/image8.png){width="2.4868055555555557in"
...
![](lab-06/media/image9.png){width="3.1145833333333335in"
height="2.5625in"}
...
![](lab-06/media/image10.png){width="3.0069444444444446in"
...
![](lab-06/media/image11.png){width="4.368055555555555in"
...
![](lab-06/media/image12.png){width="5.716666666666667in"
...
![](lab-06/media/image13.png){width="1.9694444444444446in"
...
![](lab-06/media/image14.png){width="2.9611111111111112in"
...
![](lab-06/media/image15.png){width="2.223611111111111in"
height="1.1201388888888888in"}

5.  메뉴에서 **새 의미 체계 모델**을 선택합니다.

![](lab-06/media/image16.png){width="3.720833333333333in"
...
![](lab-06/media/image17.png){width="2.5388888888888888in"
...
![](lab-06/media/image18.png){width="5.9222222222222225in"
height="7.214583333333334in"}
...
![](lab-06/media/image19.png){width="5.428472222222222in"
height="1.2208333333333334in"}

2.  **데이터 모델 열기**를 클릭합니다.

![](lab-06/media/image20.png){width="6.045138888888889in"
height="0.2465277777777778in"}

3.  오른쪽 위 모서리에서 **편집** 모드에 있는지 확인합니다

![](lab-06/media/image21.png){width="2.765972222222222in"
height="1.7145833333333333in"}

4.  첫 번째 단계는 이러한 테이블 간에 관계를 만드는 것입니다.

![](lab-06/media/image22.png){width="4.194444444444445in"
...
![](lab-06/media/image23.png){width="5.364583333333333in"
...
![](lab-06/media/image24.png){width="3.0722222222222224in"
...
![](lab-06/media/image25.png){width="4.266666666666667in"
height="4.997222222222222in"}
...
![](lab-06/media/image26.png){width="4.134722222222222in"
...
![](lab-06/media/image27.png){width="4.688194444444444in"
...
![](lab-06/media/image28.png){width="4.552083333333333in"
...
![](lab-06/media/image29.png){width="6.2659722222222225in"
...
![](lab-06/media/image30.png){width="1.7520833333333334in"
...
![](lab-06/media/image31.png){width="5.3381944444444445in"
...
![](lab-06/media/image32.png){width="2.3361111111111112in"
...
![](lab-06/media/image33.png){width="2.9006944444444445in"
height="3.36875in"}
...
![](lab-06/media/image34.png){width="2.84375in"
...
![](lab-06/media/image35.png){width="3.801388888888889in"
...
![](lab-06/media/image36.png){width="6.104166666666667in"
...
![](lab-06/media/image37.png){width="6.184027777777778in"
...
![](lab-06/media/image38.png){width="1.8694444444444445in"
height="4.34375in"}
