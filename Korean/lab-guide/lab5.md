...
[3](#작업-1-공급자-데이터-흐름에-대한-예약-새로-고침-구성)](#작업-1-공급자-데이터-흐름에-대한-예약-새로-고침-구성)

[데이터 파이프라인 [7](#데이터-파이프라인)](#데이터-파이프라인)

[작업 2: 데이터 파이프라인 만들기
[7](#작업-2-데이터-파이프라인-만들기)](#작업-2-데이터-파이프라인-만들기)

[작업 3: 간단한 데이터 파이프라인 구축
[9](#작업-3-간단한-데이터-파이프라인-구축)](#작업-3-간단한-데이터-파이프라인-구축)

[작업 4: 새 데이터 파이프라인 만들기
[11](#작업-4-새-데이터-파이프라인-만들기)](#작업-4-새-데이터-파이프라인-만들기)

[작업 5: Until 작업 만들기
[12](#작업-5-until-작업-만들기)](#작업-5-until-작업-만들기)

[작업 6: 변수 만들기 [13](#작업-6-변수-만들기)](#작업-6-변수-만들기)

[작업 7: Until 작업 구성
[15](#작업-7-until-작업-구성)](#작업-7-until-작업-구성)

[작업 8: 데이터 흐름 작업 구성
[20](#작업-8-데이터-흐름-작업-구성)](#작업-8-데이터-흐름-작업-구성)

[작업 9: 첫 번째 변수 설정 작업 구성
[22](#작업-9-첫-번째-변수-설정-작업-구성)](#작업-9-첫-번째-변수-설정-작업-구성)

[작업 10: 두 번째 변수 설정 작업 구성
[24](#작업-10-두-번째-변수-설정-작업-구성)](#작업-10-두-번째-변수-설정-작업-구성)

[작업 11: 세 번째 변수 설정 작업 구성
[25](#작업-11-세-번째-변수-설정-작업-구성)](#작업-11-세-번째-변수-설정-작업-구성)

[작업 12: 대기 작업 구성
[27](#작업-12-대기-작업-구성)](#작업-12-대기-작업-구성)

[작업 13: 데이터 파이프라인에 대한 예약 새로 고침 구성
[30](#작업-13-데이터-파이프라인에-대한-예약-새로-고침-구성)](#작업-13-데이터-파이프라인에-대한-예약-새로-고침-구성)
...
![](lab-05/media/image6.png){width="4.756935695538058in"
height="2.3906813210848643in"}

3.  생성한 모든 아티팩트가 여기에 나열됩니다. 화면 오른쪽에 있는 **검색
    창**에 **df**를 입력합니다. 그러면 아티팩트가 데이터 흐름으로
    필터링됩니다.

![](lab-05/media/image7.png){width="3.83244750656168in"
height="1.1261220472440945in"}
...
![](lab-05/media/image8.png){width="3.1074518810148732in"
height="2.578033683289589in"}
...
![](lab-05/media/image9.png){width="6.279847987751531in"
height="1.8766054243219596in"}
...
![](lab-05/media/image10.png){width="5.395326990376203in"
height="1.323167104111986in"}
...
![](lab-05/media/image11.png){width="5.482159886264217in"
height="3.011165791776028in"}
...
![](lab-05/media/image12.png){width="6.170166229221348in"
height="2.2961100174978126in"}
...
![](lab-05/media/image13.png){width="5.277307524059492in"
height="4.364186351706037in"}
...
![](lab-05/media/image14.png){width="5.145087489063867in"
height="2.05742782152231in"}

3.  새 파이프라인 대화 상자가 열립니다. 파이프라인의 이름을
    **pl_Refresh_People_SharePoint** (3)로 지정하고 **만들기** (4)를
    선택합니다.

![](lab-05/media/image15.png){width="4.329583333333333in"
height="3.396259842519685in"}
...
![](lab-05/media/image16.png){width="4.498347550306212in"
height="2.434958442694663in"}
...
![](lab-05/media/image17.png){width="6.173360673665792in"
height="3.18715113735783in"}
...
![](lab-05/media/image18.png){width="5.677876202974629in"
height="0.7807075678040245in"}
...
![](lab-05/media/image19.png){width="5.168090551181102in"
height="3.016395450568679in"}
...
![](lab-05/media/image20.png){width="3.1215004374453192in"
height="4.767939632545931in"}
...
![](lab-05/media/image21.png){width="4.856070647419073in"
height="3.349296806649169in"}

3.  새 파이프라인 대화 상자가 열립니다. 파이프라인의 **이름**을
    **pl_Refresh_People_SharePoint_Option2** **(3)**로 지정하고 **만들기
    (4)**를 선택합니다.

> ![](lab-05/media/image22.png){width="4.924352580927384in"
> height="3.8038418635170603in"}
...
![](lab-05/media/image23.png){width="6.1701126421697285in"
height="3.262175196850394in"}
...
![](lab-05/media/image24.png){width="5.789944225721785in"
height="4.664772528433946in"}
...
![](lab-05/media/image25.png){width="3.5970734908136484in"
...
![](lab-05/media/image26.png){width="2.661459973753281in"
height="3.3307469378827648in"}
...
![](lab-05/media/image27.png){width="3.121832895888014in"
height="3.028176946631671in"}
...
![](lab-05/media/image28.png){width="3.6482381889763777in"
height="2.929374453193351in"}
...
![](lab-05/media/image29.png){width="2.7484634733158355in"
height="3.9674278215223096in"}
...
![](lab-05/media/image30.png){width="2.4361231408573927in"
height="1.9294761592300962in"}
...
![](lab-05/media/image31.png){width="2.0093416447944006in"
height="2.7907524059492563in"}
...
![](lab-05/media/image32.png){width="2.3382458442694665in"
height="2.888708442694663in"}
...
![](lab-05/media/image33.png){width="5.591545275590551in"
height="2.8011373578302714in"}
...
![](lab-05/media/image34.png){width="2.9983442694663167in"
height="4.031175634295713in"}
...
![](lab-05/media/image35.png){width="3.412047244094488in"
height="2.3063298337707785in"}
...
![](lab-05/media/image36.png){width="2.1556780402449696in"
...
![](lab-05/media/image37.png){width="3.7087642169728783in"
height="3.307650918635171in"}
...
![](lab-05/media/image38.png){width="4.984615048118985in"
height="3.3406397637795275in"}
...
![](lab-05/media/image39.png){width="3.8128991688538934in"
height="3.4843864829396325in"}
...
![](lab-05/media/image40.png){width="2.635246062992126in"
height="2.47in"}
...
![](lab-05/media/image41.png){width="5.958864829396325in"
height="4.44861220472441in"}
...
![](lab-05/media/image42.png){width="4.929689413823272in"
height="2.966943350831146in"}
...
![](lab-05/media/image43.png){width="4.066181102362204in"
height="3.1321172353455817in"}
...
![](lab-05/media/image44.png){width="4.308022747156605in"
height="2.6653324584426947in"}
...
![](lab-05/media/image45.png){width="5.7800656167979in"
height="2.360637576552931in"}
...
![](lab-05/media/image46.png){width="4.441195319335083in"
height="2.5215069991251093in"}
...
![](lab-05/media/image47.png){width="6.163587051618547in"
height="2.370968941382327in"}

10. 설계 캔버스의 왼쪽 상단에서 **pl_Refresh_People_Sharepoint_Option2**
    또는 **기본 캔버스**를 선택하여 Until 반복기에서 빠져나옵니다.

![](lab-05/media/image48.png){width="5.693880139982502in"
height="2.3404899387576554in"}

11. 데이터 파이프라인 생성이 완료되었습니다. 상단 메뉴에서 **홈 -\> 저장
    아이콘**을 선택하여 데이터 파이프라인을 저장합니다.

![](lab-05/media/image49.png){width="2.5682108486439197in"
height="2.4482020997375327in"}
...
![](lab-05/media/image50.png){width="2.9610214348206476in"
height="3.0189293525809275in"}
...
![](lab-05/media/image51.png){width="1.7914031058617672in"
height="4.160846456692913in"}
