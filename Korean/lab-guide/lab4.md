...
1. 팝업 창에서 **"Git 통합, 배포 파이프라인 및 Public API 시나리오 활성화" 상자(1)** 의 선택을 해제한 다음, **"만들기(2)"** 를 클릭하세요.


   ![](../media/lab-04/Lab-4-Korean.png) 
...
1. 팝업 창에서 **'Git 통합, 배포 파이프라인 및 공개 API 시나리오 사용' 상자 (1)** 의 선택을 해제한 후, **'만들기 (2)** 를 클릭하세요.
