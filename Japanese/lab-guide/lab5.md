...
[Dataflow Gen2 [4](#dataflow-gen2)](#dataflow-gen2)

[タスク 1: Supplier データフローのスケジュールされた更新を構成する
[4](#タスク-1-supplier-データフローのスケジュールされた更新を構成する)](#タスク-1-supplier-データフローのスケジュールされた更新を構成する)

[データ パイプライン [8](#データ-パイプライン)](#データ-パイプライン)

[タスク 2: データ パイプラインを作成する
[8](#タスク-2-データ-パイプラインを作成する)](#タスク-2-データ-パイプラインを作成する)

[タスク 3: シンプルなデータ パイプラインを構築する
[10](#タスク-3-シンプルなデータ-パイプラインを構築する)](#タスク-3-シンプルなデータ-パイプラインを構築する)

[タスク 4: 新しいデータ パイプラインを作成する
[12](#タスク-4-新しいデータ-パイプラインを作成する)](#タスク-4-新しいデータ-パイプラインを作成する)

[タスク 5: Until アクティビティを作成する
[13](#タスク-5-until-アクティビティを作成する)](#タスク-5-until-アクティビティを作成する)

[タスク 6: 変数を作成する
[14](#タスク-6-変数を作成する)](#タスク-6-変数を作成する)

[タスク 7: Until アクティビティを構成する
[15](#タスク-7-until-アクティビティを構成する)](#タスク-7-until-アクティビティを構成する)

[タスク 8: データフロー アクティビティを構成する
[21](#タスク-8-データフロー-アクティビティを構成する)](#タスク-8-データフロー-アクティビティを構成する)

[タスク 9: 最初の変数の設定アクティビティを構成する
[23](#タスク-9-最初の変数の設定アクティビティを構成する)](#タスク-9-最初の変数の設定アクティビティを構成する)

[タスク 10: 2 番目の変数の設定アクティビティを構成する
[26](#タスク-10-2-番目の変数の設定アクティビティを構成する)](#タスク-10-2-番目の変数の設定アクティビティを構成する)

[タスク 11: 3 番目の変数の設定アクティビティを構成する
[27](#タスク-11-3-番目の変数の設定アクティビティを構成する)](#タスク-11-3-番目の変数の設定アクティビティを構成する)

[タスク 12: Wait アクティビティを構成する
[29](#タスク-12-wait-アクティビティを構成する)](#タスク-12-wait-アクティビティを構成する)

[タスク 13: データ パイプラインのスケジュールされた更新を構成する
[33](#タスク-13-データ-パイプラインのスケジュールされた更新を構成する)](#タスク-13-データ-パイプラインのスケジュールされた更新を構成する)
...
![](images5/media/image6.png){width="5.187625765529309in"
height="2.4138560804899387in"}

3.  作成したすべてのアーティファクトがここに一覧表示されています。画面右側にある**検索ボックス**に、**df**
    と入力します。これにより、アーティファクトがデータフローに絞り込まれます。

![](images5/media/image7.png){width="5.632489063867016in"
height="1.2815365266841645in"}

4.  **df_Supplier_Snowflake**
    行をポイントします。見慣れた**更新アイコン**と**スケジュールされている更新アイコン**が表示されます。**省略記号
    (...)** を選択します。

5.  データフローを削除、編集、エクスポートするオプションがあることがわかります。\
    \[プロパティ\]
    を使用して、データフローの名前と説明を更新することができます。\
    \[更新履歴\] については後ほど見ていきます。**設定**を選択します。

![](images5/media/image8.png){width="4.400014216972878in"
height="4.435925196850394in"}
...
![](images5/media/image9.png){width="6.371310148731409in"
height="1.6960990813648293in"}

7.  \[更新履歴\]
    ダイアログが開きます。更新の一覧が表示されます。これは、\
    データフローを公開したときに発生した更新です。**開始時刻**のリンクを選択します。

**注:** 開始時間はお客様によって異なります。

![](images5/media/image10.png){width="4.377474846894138in"
height="0.9114260717410324in"}

\[詳細\]
画面が開きます。開始時刻、終了時刻、期間など、更新の詳細情報を確認できます。また、更新されたテーブルとアクティビティも一覧表示されます。失敗が発生した場合は、テーブルやアクティビティの名前をクリックしてさらに調査できます。

![](images5/media/image11.png){width="3.732629046369204in"
height="2.0167924321959756in"}
...
![](images5/media/image12.png){width="5.610582895888014in"
height="1.6878116797900262in"}
...
![](images5/media/image13.png){width="5.435133420822397in"
height="4.3270002187226595in"}
...
2.  上部メニューで、**+ 新しい項目 (1) - \>** **データ パイプライン
    (2)** を選択します。

![](images5/media/image14.png){width="3.0347222222222223in"
height="1.19250656167979in"}

3.  \[新しいパイプライン\] ダイアログが開きます。パイプラインに
    **pl_Refresh_People_SharePoint** (3) という名前を付け、**作成** (4)
    を選択します。

![](images5/media/image15.png){width="4.117401574803149in"
height="3.2024234470691164in"}
...
を追加するオプションがあります。また、\
中央ペインには、パイプラインの構築を開始するためのクイック
オプションがあります。

![](images5/media/image16.png){width="4.5396052055993in"
height="2.662011154855643in"}
...
![](images5/media/image17.png){width="4.380237314085739in"
height="1.6425885826771653in"}
...
![](images5/media/image18.png){width="4.411340769903762in"
height="0.5080468066491689in"}
...
![](images5/media/image19.png){width="5.01772419072616in"
height="2.451841644794401in"}
...
![](images5/media/image20.png){width="2.721829615048119in"
height="3.255521653543307in"}
...
![](images5/media/image21.png){width="4.215080927384077in"
...
![](images5/media/image22.png){width="3.6469346019247593in"
height="2.8536439195100614in"}
...
![](images5/media/image23.png){width="4.282501093613298in"
height="2.6508945756780404in"}
...
![](images5/media/image24.png){width="3.301035651793526in"
height="2.185919728783902in"}
...
![](images5/media/image25.png){width="3.4732753718285214in"
...
![](images5/media/image26.png){width="2.5891141732283462in"
height="2.905177165354331in"}
...
![](images5/media/image27.png){width="3.2693963254593177in"
height="3.124987970253718in"}
...
![](images5/media/image28.png){width="2.5425360892388453in"
height="3.7615004374453194in"}
...
![](images5/media/image29.png){width="2.885262467191601in"
height="4.389067147856518in"}
...
![](images5/media/image30.png){width="3.307141294838145in"
height="2.3854779090113736in"}
...
![](images5/media/image31.png){width="2.8819914698162727in"
height="2.8867311898512686in"}
...
![](images5/media/image32.png){width="2.5983530183727033in"
height="2.452377515310586in"}
...
![](images5/media/image33.png){width="2.6in"
height="1.1001574803149605in"}
...
![](images5/media/image34.png){width="2.5042771216097988in"
height="3.409822834645669in"}
...
![](images5/media/image35.png){width="3.56957895888014in"
height="2.2085673665791776in"}
...
![](images5/media/image36.png){width="4.261932414698163in"
height="3.2323075240594927in"}
...
![](images5/media/image37.png){width="4.339574584426947in"
height="2.664437882764654in"}

### タスク 9: 最初の変数の設定アクティビティを構成する

ラボで前に行ったように、データフロー
アクティビティを構成しました。次に、\
新しいロジックを追加します。データフローの更新が成功した場合は、\
Until の反復処理から抜ける必要があります。反復処理から抜ける条件の 1
...
![](images5/media/image38.png){width="5.848963254593176in"
height="3.289057305336833in"}
...
![](images5/media/image39.png){width="3.4290824584426947in"
height="3.234134951881015in"}
...
![](images5/media/image40.png){width="2.5820067804024496in"
height="2.4695647419072615in"}
...
![](images5/media/image41.png){width="6.19in"
height="3.8411154855643046in"}
...
![](images5/media/image42.png){width="4.620238407699038in"
height="3.3695002187226595in"}
...
![](images5/media/image43.png){width="6.2in"
height="3.8056681977252844in"}
...
![](images5/media/image44.png){width="5.5486231408573925in"
height="3.973261154855643in"}
...
![](images5/media/image45.png){width="6.151129702537183in"
height="2.9153554243219597in"}
...
![](images5/media/image46.png){width="5.2239938757655295in"
height="3.0464359142607176in"}
...
activity](images5/media/image47.png){width="6.2in"
height="1.9649245406824147in"}

10. デザイン キャンバスの左上で **pl_Refresh_People_Sharepoint_Option2**
    またはメイン キャンバスを選択して、Until 反復処理から移動します。

![](images5/media/image48.png){width="5.735226377952756in"
...
![](images5/media/image49.png){width="3.5521784776902887in"
height="3.0895002187226597in"}
...
![](images5/media/image50.png){width="3.412286745406824in"
height="3.0714687226596675in"}
...
![](images5/media/image51.png){width="1.8141896325459317in"
height="4.33in"}
