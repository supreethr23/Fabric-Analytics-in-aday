...
[Fabric ライセンス [3](#fabric-ライセンス)](#fabric-ライセンス)

[タスク 1: Microsoft Fabric 試用版ライセンスを有効にする
[3](#タスク-1-microsoft-fabric-試用版ライセンスを有効にする)](#タスク-1-microsoft-fabric-試用版ライセンスを有効にする)

[Fabric ワークスペース
[6](#fabric-ワークスペース)](#fabric-ワークスペース)

[タスク 2: Fabric ワークスペースを作成する
[6](#タスク-2-fabric-ワークスペースを作成する)](#タスク-2-fabric-ワークスペースを作成する)

[タスク 3: レイクハウスを作成する
[9](#タスク-3-レイクハウスを作成する)](#タスク-3-レイクハウスを作成する)

[Fabric のエクスペリエンスの概要
[10](#fabric-のエクスペリエンスの概要)](#fabric-のエクスペリエンスの概要)

[タスク 4: Data Factory のエクスペリエンス
[10](#タスク-4-data-factory-のエクスペリエンス)](#タスク-4-data-factory-のエクスペリエンス)

[タスク 5: Industry Solutions のエクスペリエンス
[14](#タスク-5-industry-solutions-のエクスペリエンス)](#タスク-5-industry-solutions-のエクスペリエンス)

[タスク 6: Real-Time Intelligence エクスペリエンス
[16](#タスク-6-real-time-intelligence-エクスペリエンス)](#タスク-6-real-time-intelligence-エクスペリエンス)

[タスク 7: Data Engineering のエクスペリエンス
[18](#タスク-7-data-engineering-のエクスペリエンス)](#タスク-7-data-engineering-のエクスペリエンス)

[タスク 8: Data Science のエクスペリエンス
[21](#タスク-8-data-science-のエクスペリエンス)](#タスク-8-data-science-のエクスペリエンス)

[タスク 9: Data Warehouse のエクスペリエンス
[23](#タスク-9-data-warehouse-のエクスペリエンス)](#タスク-9-data-warehouse-のエクスペリエンス)

[タスク 10: データベースのエクスペリエンス
[25](#タスク-10-データベースのエクスペリエンス)](#タスク-10-データベースのエクスペリエンス)
...
![](images2/media/image6.png){width="2.294711286089239in"
height="2.1355194663167105in"}
...
![](images2/media/image7.png){width="3.3463167104111986in"
height="2.9009897200349957in"}

4.  次に、以下の**パスワード**を入力し、**サインイン**をクリックします。

    -   **パスワード:** \[環境\] タブで見つけることができます

![](images2/media/image8.png){width="4.307706692913386in"
height="3.415840988626422in"}
...
![](images2/media/image9.png){width="6.065860673665791in"
height="2.3854997812773404in"}

9.  Microsoft Fabric
    の無料試用版にアップグレードするダイアログが開きます。\
    **アクティブ化**を選択します。

![](images2/media/image10.png){width="5.495031714785652in"
height="4.955167322834646in"}

10. Microsoft Fabric
    へのアップグレード成功のダイアログが開きます。**Fabric Home\
    Page** を選択します。

![](images2/media/image11.png){width="5.740463692038495in"
height="2.2536636045494314in"}

11. **Microsoft** **Fabric のホーム ページ**が開きます。

![](images2/media/image12.png){width="6.2960761154855645in"
height="3.386451224846894in"}
...
![](images2/media/image13.png){width="4.043167104111986in"
height="6.1538046806649165in"}
...
![](images2/media/image14.png){width="2.4324857830271216in"
height="3.4991666666666665in"}
...
![](images2/media/image15.png){width="2.600009842519685in"
height="3.2591666666666668in"}

新しいワークスペースが作成されて、そのワークスペースに移動できます。さまざまなデータ
ソースからレイクハウスにデータを取り込み、そのレイクハウスからのデータを使用してモデルを構築し、レポートを作成します。最初のステップでは、レイクハウスを作成\
します。
...
![](images2/media/image16.png){width="6.187087707786526in"
height="1.401104549431321in"}
...
3.  新しいレイクハウスのダイアログが表示されます。\[名前\]
    ...
    ***注:** プレビュー機能である**レイクハウス
    スキーマ**は、非常に興味深い機能であるため、知っておいてください。これは**プレビュー**状態であるため、ラボ環境に悪影響がないように無視します。機能が一般提供になったら、このラボに組み込みます。*

4.  **作成**を選択します

![](images2/media/image17.png){width="2.523721566054243in"
height="1.7585509623797024in"}
...
![](images2/media/image18.png){width="3.0864884076990378in"
height="5.6206594488188975in"}
...
1.  画面左側のワークロード
    ...
    \
    ![](images2/media/image19.png){width="6.284909230096238in"
    height="3.067166447944007in"}

2.  **Data Factory** を選択します。

![](images2/media/image20.png){width="6.318140857392826in"
height="2.763167104111986in"}
...
![](images2/media/image21.png){width="6.099166666666667in"
height="3.0583300524934383in"}

4.  画面の左上隅にある**ワークロードに戻る**をクリックします。このアクションによって主要なワークロードのページが表示され、そこで他のツールやセクションを探索\
    できます。

![](images2/media/image22.png){width="2.6in"
height="0.49760717410323707in"}
...
1.  **ワークロード ページ**で、**Industry** Solutions
    をクリックして先に進みます。\
    \
    ![](images2/media/image23.png){width="6.284082458442695in"
...
![](images2/media/image24.png){width="6.089087926509186in"
height="2.642361111111111in"}

2.  Real-Time Intelligence のホーム
    ページが表示されます。以下は、Real-Time\
    Intelligence
    を手順に従って効果的に使用できるように設計されたセクションの詳細な概要です。
...
b\. **サンプルの探索:** \[選択\] ボタンをクリックし、サンプルを使用して
Real-Time Intelligence について学びます。
...
f\. **サンプルのアクティベーターを探索する:** \[開く\]
ボタンをクリックし、サンプルのアクティベーターを使用して Real-Time
Intelligence の機能について理解します。

g\. **アクティベーターの使用を開始する:** \[開く\]
ボタンをクリックして、アクティベーターの概念について概要を確認し、ツールの効果的な使用を開始します。

![](images2/media/image25.png){width="5.292312992125984in"
height="2.6751673228346458in"}
...
![](images2/media/image26.png){width="4.1507972440944885in"
height="2.4111668853893264in"}
...
\
![](images2/media/image27.png){width="4.667166447944007in"
height="2.357917760279965in"}
...
> ![](images2/media/image28.png){width="5.772839020122484in"
...
\
![](images2/media/image29.png){width="5.683167104111986in"
height="2.856339676290464in"}
...
![](images2/media/image30.png){width="5.059166666666667in"
height="1.479537401574803in"}
...
g\. **ミラー化された Azure Cosmos DB:** Azure Cosmos DB
をミラーリングするために使用\
されます。

h\. **Mirrored Azure Database for PostgreSQL (preview):** 既存の Azure
Database for PostgreSQL をミラーリングするために使用されます。\
i. **Mirrored Azure SQL Managed Database:** 高可用性とディザスター
リカバリーのために Azure SQL Managed Database
をミラーリングするのに使用されます。

j\. **ミラー化されたデータベース (プレビュー):** 高可用性とディザスター
...
![](images2/media/image31.png){width="4.711839457567804in"
height="2.343727034120735in"}
...
1.  **ワークロード** ページで、**Databases**
    をクリックして先に進みます。\
    \
    ![](images2/media/image32.png){width="2.9398654855643045in"
    height="4.883166010498687in"}
...
\
![](images2/media/image33.png){width="5.365217629046369in"
height="2.6826082677165353in"}
...
![](images2/media/image34.png){width="1.8604352580927384in"
