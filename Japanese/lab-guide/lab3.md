...
[ADLS Gen2 へのショートカット
[4](#adls-gen2-へのショートカット)](#adls-gen2-へのショートカット)

[タスク 1: ショートカットを作成する
[4](#タスク-1-ショートカットを作成する)](#タスク-1-ショートカットを作成する)

[ビジュアル クエリを使用してデータを変換する
[8](#ビジュアル-クエリを使用してデータを変換する)](#ビジュアル-クエリを使用してデータを変換する)

[タスク 2: ビジュアル クエリを使用して Geo ビューを作成する
[8](#タスク-2-ビジュアル-クエリを使用して-geo-ビューを作成する)](#タスク-2-ビジュアル-クエリを使用して-geo-ビューを作成する)

[タスク 3: ビジュアル クエリを使用して Reseller ビューを作成する
[17](#タスク-3-ビジュアル-クエリを使用して-reseller-ビューを作成する)](#タスク-3-ビジュアル-クエリを使用して-reseller-ビューを作成する)

[タスク 4: ビジュアル クエリを使用して Sales ビューを作成する
[22](#タスク-4-ビジュアル-クエリを使用して-sales-ビューを作成する)](#タスク-4-ビジュアル-クエリを使用して-sales-ビューを作成する)

[タスク 5: ビジュアル クエリを使用して Product ビューを作成する
[29](#タスク-5-ビジュアル-クエリを使用して-product-ビューを作成する)](#タスク-5-ビジュアル-クエリを使用して-product-ビューを作成する)
...
![](images3/media/image6.png){width="4.93588145231846in"
height="5.533622047244094in"}

5.  **新しいショートカット**
    ダイアログが開きます。**外部ソース**で、**Azure Data Lake Storage
    Gen2** を選択します。

![](images3/media/image7.png){width="5.798885608048994in"
height="3.2553018372703413in"}
...
![](images3/media/image8.png){width="4.929662073490814in"
height="2.7785378390201223in"}
...
![](images3/media/image9.png){width="3.607879483814523in"
height="3.0279090113735783in"}
...
![](images3/media/image10.png){width="5.494017935258093in"
height="1.6853751093613298in"}
...
![](images3/media/image11.png){width="5.931879921259842in"
height="3.375180446194226in"}

19. すべてのショートカットがテーブルとして作成されていることに注意してください。**BuyingGroups**
    テーブルを選択し、データ
    パネルにデータのプレビューが表示されることを確認してください。

![](images3/media/image12.png){width="5.422648731408574in"
height="2.9468536745406824in"}
...
![](images3/media/image13.png){width="5.632632327209099in"
height="1.25252624671916in"}
...
![](images3/media/image14.png){width="2.8308180227471564in"
height="2.627681539807524in"}
...
![](images3/media/image15.png){width="4.35553258967629in"
...
![](images3/media/image16.png){width="6.2176509186351705in"
height="2.7127220034995627in"}

6.  **Cities (1)** クエリを選択した状態で、Power Query
    エディターのリボンから**ホーム (2) -\> 結合 (3) -\> クエリのマージ
    ドロップダウン (4) -\> 新規としてクエリをマージ (5)** を選択します。

![](images3/media/image17.png){width="5.967305336832896in"
...
![](images3/media/image18.png){width="4.184527559055118in"
height="4.207053805774279in"}
...
![](images3/media/image20.png){width="5.495846456692913in"
height="2.0224715660542434in"}
...
![](images3/media/image21.png){width="3.6167574365704285in"
height="3.626584645669291in"}
...
![](images3/media/image22.png){width="1.8798009623797025in"
...
![](images3/media/image23.png){width="5.998299431321085in"
...
![](images3/media/image24.png){width="1.967202537182852in"
height="2.568021653543307in"}
...
![](images3/media/image25.png){width="4.298885608048994in"
height="2.1478248031496063in"}
...
![](images3/media/image26.png){width="4.749381014873141in"
height="2.0886395450568678in"}
...
![](images3/media/image27.png){width="2.7790846456692915in"
height="3.104647856517935in"}
...
![](images3/media/image28.png){width="2.4434273840769904in"
height="3.5711636045494313in"}
...
![](images3/media/image29.png){width="5.711839457567804in"
height="6.370898950131234in"}
...
![](images3/media/image30.png){width="4.4275995188101485in"
height="2.076755249343832in"}
...
![](images3/media/image31.png){width="3.0988057742782154in"
height="3.1850251531058618in"}
...
![](images3/media/image32.png){width="2.749381014873141in"
height="2.7332075678040244in"}
...
![](images3/media/image33.png){width="5.487004593175853in"
height="1.3745570866141732in"}
...
![](images3/media/image34.png){width="2.0462696850393702in"
height="3.3747397200349956in"}
...
![](images3/media/image35.png){width="4.889804243219597in"
height="2.3244641294838146in"}
...
![](images3/media/image36.png){width="2.1107677165354333in"
height="1.7914271653543308in"}
...
![](images3/media/image37.png){width="3.1553215223097113in"
height="1.1947331583552057in"}
...
![](images3/media/image38.png){width="2.665223097112861in"
height="2.941349518810149in"}
...
![](images3/media/image39.png){width="2.865586176727909in"
height="2.9262685914260715in"}
...
![](images3/media/image40.png){width="4.264724409448819in"
height="3.1693635170603676in"}
...
![](images3/media/image41.png){width="6.409352580927384in"
height="2.3925109361329833in"}
...
![](images3/media/image42.png){width="5.226445756780403in"
...
![](images3/media/image43.png){width="3.134802055993001in"
height="3.1818449256342958in"}
...
![](images3/media/image44.png){width="6.5in"
height="1.8438615485564305in"}
...
![](images3/media/image45.png){width="2.9732141294838144in"
height="3.694783464566929in"}
...
![](images3/media/image46.png){width="5.57421697287839in"
height="2.54378937007874in"}
...
![](images3/media/image47.png){width="4.120406824146982in"
height="1.9941010498687664in"}
...
generated](images3/media/image48.png){width="6.5in"
height="0.9915244969378828in"}

![A screenshot of a computer Description automatically
generated](images3/media/image49.png){width="3.451421697287839in"
height="2.464314304461942in"}

25. コードの最後の 2 行 (ソース内) を強調表示して**削除**します。

26. **OK** をクリックして変更を保存します。

![](images3/media/image50.png){width="5.754528652668417in"
height="3.1750601487314087in"}
...
![](images3/media/image51.png){width="2.506806649168854in"
...
![](images3/media/image52.png){width="3.8545384951881014in"
height="4.271245625546807in"}
...
![](images3/media/image53.png){width="3.2216699475065615in"
height="3.2in"}
...
![](images3/media/image54.png){width="4.672236439195101in"
height="2.7138735783027124in"}
...
![](images3/media/image55.png){width="5.791666666666667in"
height="5.947728565179353in"}
...
![](images3/media/image56.png){width="6.313846237970254in"
height="3.23875in"}
...
![](images3/media/image57.png){width="6.5in"
height="2.4705172790901138in"}
...
![](images3/media/image58.png){width="3.0086843832020995in"
height="3.057871828521435in"}

11. マージ クエリを選択した状態で、リボンから**ホーム -\>
    詳細エディター**を選択します。\[詳細エディター\]
    ダイアログが開きます。

![](images3/media/image59.png){width="3.6984055118110235in"
...
![](images3/media/image61.png){width="6.2612412510936135in"
height="2.564673009623797in"}
...
![](images3/media/image62.png){width="3.0069444444444446in"
height="3.3320188101487314in"}
...
![](images3/media/image63.png){width="1.8384897200349957in"
height="1.8986275153105863in"}
...
![](images3/media/image64.png){width="1.3405522747156606in"
height="3.2668503937007873in"}
