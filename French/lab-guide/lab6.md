...
3. Vous voyez trois éléments associés à lh_FAIAD: Lakehouse,
    Modèle sémantique et Point de terminaison SQL. Nous avons exploré la
    ...
    l'option **Point de terminaison Analytique SQL lh_FAIAD** pour
    continuer à explorer cette option. Vous êtes alors redirigé vers la
    **vue SQL** de l'explorateur.
...
5. Dans le menu, cliquez sur **Nouveau modèle sémantique**.
