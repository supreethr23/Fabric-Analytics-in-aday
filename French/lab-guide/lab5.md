...
7. La boîte de dialogue Historique des actualisations s'ouvre alors.
    ...
    **Remarque :** l'heure de début est différente pour vous.
    ...
    durée. Il répertorie également les tables/activités actualisées.
    En cas d'échec, vous pouvez cliquer sur le nom de la table/l'activité
...
3. Une boîte de dialogue Nouveau pipeline s'ouvre alors. Nommez le
    pipeline **pl_Refresh_People_SharePoint** **(3)** et cliquez sur
    **Créer** **(4)**.
...
13. Dans le menu, cliquez sur l'icône **Accueil -> Enregistrer** pour
    ...
    - Le pipeline permet d'effectuer une actualisation en quelques secondes,
    alors qu'avec le flux de données, l'actualisation planifiée a lieu
