...
3. Você verá três elementos associados a **lh_FAIAD** -- Lakehouse,
    Modelo semântico e Ponto de extremidade de SQL. Exploramos o
    Lakehouse e criamos consultas de visual usando o ponto
    de extremidade da análise SQL em um laboratório anterior. Selecione
    a **Ponto de extremidade de análise de SQL lh_FAIAD** para continuar
    a explorar essa opção. Você será direcionado à **exibição de SQL**
    do explorador.
...
5. No menu, selecione **Novo modelo semântico**.
