...
Introduction	3
Power BI	3
Task 1: Auto-Create Report	3
Task 2: Configure background for a New report	7
Task 3: Add Header to the report	9
Task 4: Add KPIs to the report	10
Task 5: Add Line chart to the report	13
Task 6: Save the report	14
Task 7: Configure Year column in Date table	14
Task 8: Configure Month Name column in Date table	16
Task 9: Format Line chart	17
Task 10: Connect Power BI Desktop to Semantic model	19
Task 11: Add new data to simulate Direct Lake Mode	23
Clean up Lab environment	31
References	32
...
Commented [NP5R2]: Yes the relationships and
measures matter. I added relationship between Product and Sales as required. Now auto-created report uses some of the Product fields. However it likes Fax for some reason. I tried
hiding fax from report view. This did not help
...
17.	Let’s add another KPI. Select the Sales multi-row card we just created. Copy the visual by selecting
...
19.	With the new visual highlighted, in the Visualization pane -> Build visual -> Fields section remove
Sales measure.
...
MICROSOFT CORPORATION HEREBY DISCLAIMS ALL WARRANTIES AND CONDITIONS WITH REGARD TO THE DEMO/LAB, INCLUDING ALL WARRANTIES AND CONDITIONS OF MERCHANTABILITY, WHETHER EXPRESS, IMPLIED OR STATUTORY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON- INFRINGEMENT. MICROSOFT DOES NOT MAKE ANY ASSURANCES OR REPRESENTATIONS WITH
