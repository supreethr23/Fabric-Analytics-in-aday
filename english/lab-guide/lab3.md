...
2.  From the top menu, click the drop down next to New SQL query and then select New visual query.2.  
...
5. n the right table to merge, select BuyingGroups.
...
1. From the top menu, click the drop down next to New SQL query and then select New visual query.  
2. From Explorer -> Table section, drag the tables InvoiceLineItems andInvoices to the visual query section .
