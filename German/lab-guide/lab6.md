...
3. Sie sehen drei Elemente, die mit lh_FAIAD -- Lakehouse, dem
    ...
    Sie die Option **lh_FAIAD SQL-Analyseendpunkt** aus, um diese Option
    weiter zu erkunden. Sie werden zur **SQL-Ansicht** des Explorers
    weitergeleitet.
...
5. Wählen Sie im Menü **Neues semantisches Modell** aus.
